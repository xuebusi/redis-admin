package com.xuebusi.cms.common.servlet;
...
import com.xuebusi.cms.common.utils.FileUtils;
...
@WebServlet(urlPatterns = "/static/ckfinder/core/connector/java/connector.java", initParams = {
        ...
        @WebInitParam(name = "configuration", value = "com.xuebusi.cms.common.web.CKFinderConfig")
}, loadOnStartup = 1)
